...
#THREE
#===============================================================================
threeResult=($(mysql dbpulsa -h$HOST -u$USER -p$PASSWORD -Bse "select namaProvider, noProvider, host, span from provider where namaProvider like 'Three%' and namaProvider not like 'ThreeAll%' order by length(namaProvider), namaProvider;"))
cntThreeElm=4
